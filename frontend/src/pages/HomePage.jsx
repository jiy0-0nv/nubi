...
function Roots() {
  return (
    <svg className="hero-roots" viewBox="0 0 1200 260" fill="none" aria-hidden="true">
      <g stroke="#050406" strokeWidth="2.4" strokeLinecap="round" opacity="0.95">
      ...
      <path d="M0 260h1200V236c-120-16-210 8-320-6s-180-30-280-30-190 22-300 34S110 224 0 238z" fill="#050406" />
    </svg>
  );
}
    ...
    <>
      ...
      <section className="hero">
        ...
        <div className="hero-inner">
          <p className="hero-credit">누비 산장 · 제 1 구역 개방</p>
          <h1 className="hero-title">치악산</h1>
          <p className="hero-tagline">함부로 오르지 말 것</p>
          <p className="hero-desc">
            1987년 이후 열두 채의 산장이 이 능선 위에 세워졌습니다.
            <br />
      ...
      <div className="container page">
        ...
        {loading ? (
          ...
          <EmptyState
            mark="†"
            title="등록된 산장이 없습니다"
            description="아직 이 능선에는 아무것도 세워지지 않았습니다."
          />
        ) : (
        ...
        <div className="section-head">
          <div>
            <p className="eyebrow eyebrow-ash">입산 전 반드시 읽을 것</p>
            <h2>세 가지 규칙</h2>
          </div>
        </div>
        <div className="grid-3">
          {[
            ['첫째', '해가 진 뒤에는 산장 밖으로 나오지 마십시오.', '체크인은 15시, 체크아웃은 11시입니다.'],
            ['둘째', '방 안에서 들리는 소리에 대답하지 마십시오.', '문의는 산장지기(관리자)에게만 남겨주십시오.'],
